...
function passIframe (links, next) {
	var hostsPatterns = {'purevid.com': /^(http:\/\/)(www\.)?purevid\.com\/v\/(\w+)\/?/, 'exashare.com': /^(http:\/\/)(www\.)?exashare\.com\/(?!embed)(\w+)/, 'vodlocker.com': /^(http:\/\/)(www\.)?vodlocker\.com\/(?!embed)(\w+)/, 'played.to': /^(http:\/\/)(www\.)?played\.to\/(?!embed)(\w+)/, 'vidbull.com': /^(http:\/\/)(www\.)?vidbull\.com\/(?!embed)(\w+)/};
	var hostsReplace = {'purevid.com': "http://www.purevid.com/?m=embed&id=$3", 'exashare.com': "http://www.exashare.com/embed-$3-560x315.html", 'vodlocker.com': "http://www.vodlocker.com/embed-$3-560x315.html", 'played.to': "http://www.played.to/embed-$3-560x315.html", 'vidbull.com': "http://www.vidbull.com/embed-$3-560x315.html"};
